...
<body>
    <div class="container">
        <div class="col-sm-2">
            <a href="../Basquetbol/index.php" class="btn btn-info add-new"><i class="fa fa-plus"></i> Basquebolistas</a>
        </div>
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Listado de  <b>Futbolistas</b></h2></div>
                    <div class="col-sm-4">
                        <a href="create.php" class="btn btn-info add-new"><i class="fa fa-plus"></i> Agregar Futbolista</a>
                    </div>
                </div>
            </div>
