...
<div id="single-wrapper">
	<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" class="frm-single">
		<div class="inside">
			...
			<div class="frm-input"><input id="user" type="text" placeholder="Usuario" class="frm-inp"><i class="fa fa-user frm-ico"></i></div>
			<div class="frm-input"><input type="password" placeholder="Contraseña" class="frm-inp"><i class="fa fa-lock frm-ico"></i></div>
