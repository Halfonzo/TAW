        ...
        <div class="table-wrapper">
            ...
            <?php
				...
				if(isset($_POST) && !empty($_POST)){
					...
					$res = $clientes->create_producto($nombres, $cantidad, $precio);
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<input type="text" name="cantidad" id="apellidos" class='form-control' maxlength="100" required>
				</div>
				<div class="col-md-6">
					<label>Precio:</label>
					<input type="text" name="precio" id="telefono" class='form-control' maxlength="15" required >
				</div>
